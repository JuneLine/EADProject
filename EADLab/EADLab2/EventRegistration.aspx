<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventRegistration.aspx.cs" Inherits="EADLab2.EventRegistration" %>
        ...
        <div>
            ...
            <table>
                <tr>
                    <td>
                        Admin No:
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="tbAdminNo" ErrorMessage="Admin No is required!" class="error">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Name:
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="tbName" ErrorMessage="Name is required!" class="error">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Gender:
                        <asp:CustomValidator runat="server" ControlToValidate="rblGender" ErrorMessage="Select Gender!" class="error" ClientValidationFunction="valiateGender" ValidateEmptyText="true">*</asp:CustomValidator>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Course:
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlCourse" ErrorMessage="Select Course!" InitialValue="-1" class="error">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Event:
                        <asp:CustomValidator runat="server" ErrorMessage="Select Event!" ClientValidationFunction="validateEvent" ValidateEmptyText="true" class="error">*</asp:CustomValidator>
                        <asp:CustomValidator runat="server" ErrorMessage="Select Event!" ID="eventValidator" OnServerValidate="eventValidator_ServerValidate" class="error">*</asp:CustomValidator>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        Mobile:
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="tbMobile" ErrorMessage="Mobile is required!" class="error">*</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator runat="server" ControlToValidate="tbMobile" ErrorMessage="Mobile is not valid!" class="error" ValidationExpression="^[89]\d{7}$">!</asp:RegularExpressionValidator>
                    </td>
                    <td>
            ...
            <br />
            <div>
                <asp:ValidationSummary runat="server" HeaderText="Please resolve error:" class="error"/>
            </div>
            <br />
